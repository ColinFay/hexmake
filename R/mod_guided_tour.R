  ...
  observeEvent( input$get , {
    ...
    pmap(
      data.frame(
        ...
        texts = c(
          "Here, you can change the name displayed on the hex.", 
          "Change the x position of the name using this numeric input.", 
          "Change the y position of the name using this numeric input.",
          "You can select here a different color for the name.", 
          "Use this input to change the font used for the name.", 
          "Change the size of the name using this numeric input.", 
          "Upload a new Image from your Computer",
          "Use <a href = 'https://github.com/ropensci/magick'>{magick}</a> to modify your image.", 
