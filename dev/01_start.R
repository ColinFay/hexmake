...
golem::fill_desc(
  pkg_name = "hexmake", # The Name of the package containing the App 
  pkg_title = "Hex Stickers Maker", # The Title of the package containing the App 
  pkg_description = "A Shiny App for Making Hex Stickers.", # The Description of the package containing the App 
  author_first_name = "Colin", # Your First Name
  author_last_name = "Fay",  # Your Last Name
  author_email = "contact@colinfay.me",      # Your Email
  repo_url = "https://github.com/colinfay/hexmake" # The (optional) URL of the GitHub Repo
)     
