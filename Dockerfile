...
RUN apt-get update && apt-get install -y  git-core imagemagick libcurl4-openssl-dev libgit2-dev libmagic-dev libmagick++-dev libpng-dev libsasl2-dev libssh2-1-dev libssl-dev libxml2-dev make pandoc pandoc-citeproc zlib1g-dev libcurl4-gnutls-dev && rm -rf /var/lib/apt/lists/*
